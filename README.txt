...
patient_stats.py: A utility for calculating statistics on groups of patients

build_training_data.py: Build training examples by sliding a window over the lab time series data
